...
const UserRequests = {
    ...
    get: (id: string | undefined) => requests.get<UserDetail>(`/user/${id}`),
...
const ProductRequests = {
    ...
    get: (id:string | undefined) => requests.get<ProductDetail>(`/product/${id}`),
    update: (id: string | undefined, product: ProductDetail) => requests.put<ProductDetail>(`/product/${id}`, product),
    delete: (id: string | undefined) => requests.del<any>(`/product/${id}`),
    uploadCSV: (file: File) => {
        let formData = new FormData();
        formData.append('File', file);
...
const ServiceRequests = {
    ...
    get: (id:string | undefined) => requests.get<ServiceDetail>(`/service/${id}`),
    update: (id: string | undefined, service: ServiceDetail) => requests.put<ServiceDetail>(`/service/${id}`, service),
    delete: (id: string | undefined) => requests.del<any>(`/service/${id}`),
    uploadCSV: (file: File) => {
        let formData = new FormData();
        formData.append('File', file);
...
const ManufacturerRequests = {
    ...
    get: (id: string | undefined) => requests.get<ManufacturerDetail>(`/manufacturer/${id}`),
    update: (id: string | undefined, manufacturer: ManufacturerDetail) => requests.put<ManufacturerDetail>(`/manufacturer/${id}`, manufacturer),
    delete: (id: string | undefined) => requests.del<any>(`/manufacturer/${id}`)
}
